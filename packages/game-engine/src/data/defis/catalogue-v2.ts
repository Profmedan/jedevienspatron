...
import { montantChargeFixe } from "../../calibrage";
import { DefiDirigeant } from "../../types";

// ─── T1 — Observation silencieuse ───────────────────────────

const OBSERVATION_T1: DefiDirigeant = {
  id: "obs-t1",
  ...
  tourMax: 1,
  contexte:
    "Bienvenue, {pseudo}. Tu diriges {entreprise} depuis aujourd'hui. " +
  ...
  choix: [
    {
      ...
      effetsImmediats: [],
      pedagogie:
        "À retenir : l'Actif (à gauche) liste ce que l'entreprise possède. " +
...
const OBSERVATION_T2: DefiDirigeant = {
  id: "obs-t2",
  archetype: "observation",
  tonalite: null,
  ...
  tourMax: 2,
  contexte:
    "T2. Tu as vécu un cycle complet, {pseudo}. Compare ta trésorerie et ton résultat du premier trimestre. " +
  ...
  choix: [
    {
      ...
      effetsImmediats: [],
      pedagogie:
        "Résultat ≠ trésorerie. Une entreprise peut gagner de l'argent sur le papier (résultat positif) " +
...
const DEFI_T3_MARCHE: DefiDirigeant = {
  id: "defi-t3-marche",
  ...
  tourMax: 3,
  contexte:
    "T3, {saison}. Les concurrents de {entreprise} baissent leurs prix. " +
  ...
  choix: [
    {
      ...
      effetsImmediats: [
        ...
        { poste: "tresorerie", delta: -montantChargeFixe(0.5) },
        { poste: "chargesExceptionnelles", delta: montantChargeFixe(0.5) },
      ],
      pedagogie:
        "Tu protèges ton volume mais tu entames ta marge commerciale. " +
    ...
    },
    {
      ...
      effetsImmediats: [],
      pedagogie:
        "Tu préserves ta marge unitaire. Reste à voir si tes clients te suivent " +
...
const PALIER_T3_POSITIONNEMENT: DefiDirigeant = {
  ...
  tourMax: 3,
  contexte:
    "Décision de dirigeant, {pseudo}. Quel positionnement vas-tu donner à {entreprise} à partir de maintenant ? " +
  ...
  choix: [
      ...
      effetsDiffere: [
        {
          dansNTrimestres: 2,
          effets: [
            { poste: "ventes", delta: montantChargeFixe(1.5) },
            { poste: "achats", delta: montantChargeFixe(1.2) },
          ],
          explication:
            "Ton pari low-cost porte ses fruits : le volume de ventes monte, " +
            "mais les achats suivent. Ta marge reste fine — c'était le deal.",
        },
      ],
      pedagogie:
        "Low-cost : tu joues le volume et l'agilité opérationnelle. " +
    ...
    },
    {
      ...
      effetsDiffere: [
        {
          dansNTrimestres: 2,
          effets: [{ poste: "ventes", delta: montantChargeFixe(0.5) }],
          explication:
            "Ton positionnement médian te procure une légère croissance, sans effet de levier.",
        },
      ],
      pedagogie:
        "Milieu de gamme : facile à tenir, difficile à transformer en avantage durable. " +
    ...
    },
    {
      ...
      effetsImmediats: [
        ...
        { poste: "tresorerie", delta: -montantChargeFixe(0.5) },
        { poste: "servicesExterieurs", delta: montantChargeFixe(0.5) },
      ],
      effetsDiffere: [
        {
          dansNTrimestres: 2,
          effets: [{ poste: "ventes", delta: montantChargeFixe(1.5) }],
          explication:
            "Ton investissement qualité est perçu par le marché : tes ventes premium décollent. " +
            "Ton effort a trouvé son public.",
        },
      ],
      pedagogie:
        "Premium : tu investis maintenant pour monétiser plus tard. " +
...
const DEFI_T4_CREDIT_CLIENT: DefiDirigeant = {
  ...
  tourMax: 4,
  contexte:
    "Un gros client, {pseudo}. Il est prêt à te signer une belle commande chez " +
  ...
  choix: [
    {
      ...
      effetsImmediats: [
        { poste: "ventes", delta: montantChargeFixe(1.5) },
        { poste: "creancesPlus2", delta: montantChargeFixe(1.5) },
      ],
      pedagogie:
        "Délai long = créance à C+2 : ton chiffre d'affaires monte tout de suite, " +
    ...
    },
    {
      ...
      effetsImmediats: [
        { poste: "ventes", delta: montantChargeFixe(1) },
        { poste: "creancesPlus1", delta: montantChargeFixe(1) },
      ],
      pedagogie:
        "Créance à C+1 : équilibre raisonnable entre volume et trésorerie. Bon réflexe quand " +
    ...
    },
    {
      ...
      effetsImmediats: [
        { poste: "ventes", delta: montantChargeFixe(0.75) },
        { poste: "tresorerie", delta: montantChargeFixe(0.75) },
      ],
      pedagogie:
        "Encaissement immédiat : tréso solide, BFR inchangé, mais marge unitaire rabotée. " +
...
const OBSERVATION_T5_CREANCE_DOUTEUSE: DefiDirigeant = {
  ...
  tourMax: 5,
  contexte:
    "Mauvaise nouvelle, {pseudo}. L'un des clients de {entreprise} vient de déposer le bilan. " +
  ...
  choix: [
    {
      ...
      effetsImmediats: [
        { poste: "creancesPlus2", delta: -montantChargeFixe(0.5) },
        { poste: "chargesExceptionnelles", delta: montantChargeFixe(0.5) },
      ],
      pedagogie:
        "Principe de prudence : dès qu'une créance devient douteuse, on la sort du bilan " +
 ...
 */
export const CATALOGUE_V2: DefiDirigeant[] = [
  OBSERVATION_T1,
  OBSERVATION_T2,
  DEFI_T3_MARCHE,
...
export const CATALOGUE_V2_INDEX: Record<string, DefiDirigeant> = Object.fromEntries(
  CATALOGUE_V2.map((d) => [d.id, d])
);
