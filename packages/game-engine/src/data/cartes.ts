...
export const CLIENT_CARD_ID_BY_TYPE = {
 ...
 */
export const TYPE_BY_CLIENT_CARD_ID: Record<string, "particulier" | "tpe" | "grand_compte"> =
  Object.fromEntries(
    Object.entries(CLIENT_CARD_ID_BY_TYPE).map(([type, id]) => [id, type as "particulier" | "tpe" | "grand_compte"]),
  );
...
export const CARTES_EVENEMENTS: CarteEvenement[] = [
  ...
  },
  {
    ...
    description:
      "Une crise sanitaire frappe le monde entier. Votre activité est perturbée : coûts de protection, pertes de marchandises, désorganisation.",
    effets: [
  ...
  },
  {
    ...
    description:
      "Vos employés font grève. La production est à l'arrêt : coûts de remplacement et pertes d'exploitation.",
    effets: [
  ...
  },
  {
    ...
    description:
      "Vous remportez un appel d'offres écologique auprès d'une mairie. Contrat lucratif mais la collectivité paie en 2 trimestres — attention au BFR !",
    effets: [
...
export const CARTES_LOGISTIQUES: CarteDecision[] = [
